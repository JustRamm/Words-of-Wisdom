...
export default function WordsOfHopeScreen({
  ...
  const checkFinalOutcome = () => {
    ...
    setTimeout(() => {
      setGameState(scoreRef.current >= 12 ? "RESULTS" : "GAME_OVER");
    ...
    >
          ...
          <div className="flex items-center gap-2 md:gap-4 stickman-rescue-hdr-actions w-full md:w-auto justify-between md:justify-end">
            {gameState === "PLAYING" && (
              <div className="flex flex-col items-center bg-white/10 backdrop-blur-md border border-white/20 px-3 md:px-4 py-1.5 md:py-2 rounded-xl">
                <span className="text-[7px] md:text-[8px] font-black text-orange-400 uppercase tracking-widest leading-none mb-1">
                  🔥 Streak
                </span>
                <span className="text-white font-black text-lg md:text-2xl leading-none">
                  {streak}
                </span>
                {maxStreak > 0 && (
                  <span className="hidden md:block text-[7px] text-white/40 mt-0.5">
                    Best: {maxStreak}
                  </span>
                )}
              </div>
            ...
            <div className="flex flex-col items-end">
              <span className="text-[7px] md:text-[8px] font-black text-teal-400 uppercase tracking-widest leading-none mb-0.5 md:mb-1">
                Lvl {level}
              </span>
              <span className="text-white font-black text-sm md:text-xl leading-none">
                {score}
                <span className="text-white/30 text-[10px] md:text-sm font-medium ml-0.5 md:ml-1">
                  / 12
                </span>
              </span>
            </div>
        ...
        <div className="fixed inset-0 z-[2000] bg-slate-900/60 backdrop-blur-md flex items-center justify-center animate-fade-in">
          <div className="bg-white rounded-3xl p-10 max-w-sm w-full shadow-4xl text-center animate-scale-in">
            ...
            <p className="text-slate-500 font-medium mb-8">
              Take a moment to breathe. The path will wait for you.
            </p>
          ...
          <div className="flex md:grid md:grid-cols-3 gap-6 md:gap-8 w-full overflow-x-auto md:overflow-visible pb-8 md:pb-0 px-4 md:px-0 snap-x snap-mandatory scrollbar-hide">
            ...
            >
              ...
              <p className="text-slate-400 text-xs md:text-sm font-medium leading-relaxed">
                Slower words. Focused on learning the terminology at your own
                pace.
              </p>
              <div className="mt-6 md:mt-8 px-5 md:px-6 py-2 bg-white/10 rounded-full text-[9px] md:text-[10px] font-black text-teal-400 uppercase tracking-widest">
                Focus: Learning
              </div>
            </div>
            ...
            <div
              ...
              className={`flex-shrink-0 w-[240px] xs:w-[280px] md:w-auto snap-center p-8 md:p-10 rounded-3xl md:rounded-[3rem] backdrop-blur-xl transition-all flex flex-col items-center group shadow-4xl relative overflow-hidden ${
                unlockedLevel >= 2
            ...
            >
              {unlockedLevel >= 2 && (
                <div className="absolute top-0 right-0 px-3 md:px-4 py-1 bg-teal-500 text-white text-[7px] md:text-[8px] font-black uppercase tracking-widest rounded-bl-xl shadow-lg">
                  Recommended
                </div>
              )}
              <div
                className={`w-20 h-20 md:w-24 md:h-24 rounded-full mb-4 md:mb-6 flex items-center justify-center transition-colors ${unlockedLevel >= 2 ? "bg-white/20 group-hover:bg-white/30" : "bg-slate-800"}`}
              >
              ...
              <p className="text-slate-300 text-xs md:text-sm font-medium leading-relaxed">
                Standard speed. Balanced challenge for terminology mastery.
              </p>
              {unlockedLevel >= 2 ? (
                <div className="mt-6 md:mt-8 px-6 md:px-8 py-2.5 md:py-3 bg-teal-500 rounded-full text-[9px] md:text-[10px] font-black text-white uppercase tracking-widest shadow-xl">
                  Focus: Mastery
                </div>
              ) : (
                <div className="mt-6 md:mt-8 px-5 md:px-6 py-2 bg-white/5 rounded-full text-[8px] md:text-[9px] font-black text-slate-500 uppercase tracking-widest text-center">
            ...
            <div
              ...
              className={`flex-shrink-0 w-[240px] xs:w-[280px] md:w-auto snap-center p-6 md:p-8 rounded-3xl md:rounded-[3rem] backdrop-blur-xl transition-all flex flex-col items-center group shadow-2xl ${
                unlockedLevel >= 3
            ...
            >
              <div
                className={`w-16 h-16 md:w-20 md:h-20 rounded-full mb-4 md:mb-6 flex items-center justify-center transition-colors ${unlockedLevel >= 3 ? "bg-orange-500/20 group-hover:bg-orange-500/40" : "bg-slate-800"}`}
              >
              ...
              <p className="text-slate-400 text-xs md:text-sm font-medium leading-relaxed">
                Rapid words. Test your reflexes and quick thinking for higher
                stakes.
              </p>
              {unlockedLevel >= 3 ? (
                <div className="mt-6 md:mt-8 px-5 md:px-6 py-2 bg-white/10 rounded-full text-[9px] md:text-[10px] font-black text-orange-400 uppercase tracking-widest">
                  Focus: Reflexes
                </div>
              ) : (
                <div className="mt-6 md:mt-8 px-5 md:px-6 py-2 bg-white/5 rounded-full text-[8px] md:text-[9px] font-black text-slate-500 uppercase tracking-widest text-center">
        ...
        <>
          ...
          <div className="relative z-10 max-w-4xl w-full h-full p-8 text-center animate-fade-in flex flex-col items-center justify-center stickman-rescue-hero overflow-hidden">
            ...
            <div className="absolute bottom-12 left-0 right-0 flex flex-col items-center animate-fade-in delay-500">
              <span className="text-[10px] font-black text-white/30 uppercase tracking-[0.5em] mb-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-black text-white uppercase tracking-[0.3em] border-b border-teal-400/30 pb-1">
                  Mind Empowered
                </span>
              </div>
            </div>
      ...
      {gameState === "TUTORIAL" && (
        <div className="relative z-10 max-w-2xl w-full p-6 md:p-8 text-center animate-fade-in flex flex-col items-center stickman-rescue-tutorial">
          ...
          <h2 className="text-2xl md:text-5xl font-black text-white mb-4 md:mb-8 uppercase tracking-tighter">
            Your Mission
          </h2>
            ...
            {[
              {
                ...
                color: "teal",
                label: "Movement",
                text: "Move your cursor or touch to slide your character left and right.",
              },
              {
                num: 2,
                color: "orange",
                ...
                text: (
                  <span>
                    Catch the{" "}
                    <span className="text-white font-bold underline decoration-teal-500">
                      Seeds of Hope
                    </span>
                    . Let the harmful words pass.
                  </span>
                ),
              },
              {
                ...
                color: "red",
                label: "Warning",
                text: "You have 3 lives. Missing a Seed of Hope or catching a harmful word will cost a life.",
              },
              {
                num: 4,
                color: "white/20",
                label: "Victory",
                text: "Collect 4 Seeds of Support to master the mission and complete the lesson.",
              },
            ].map(({ num, color, label, text }) => (
              <div
                key={num}
                className="bg-white/5 border border-white/10 p-4 md:p-5 rounded-xl md:rounded-2xl backdrop-blur-md"
              >
                <div className="flex items-center gap-2 md:gap-3 mb-2 md:mb-3">
                  <div
                    className={`w-6 h-6 md:w-8 md:h-8 bg-${color}-500 rounded-lg flex items-center justify-center font-black text-white text-xs md:text-base`}
                  >
                    {num}
                  </div>
                  <span
                    className={`text-${color}-400 font-bold uppercase tracking-widest text-[8px] md:text-[10px]`}
                  >
                    {label}
                  </span>
                </div>
      ...
      {gameState === "PLAYING" && (
        <>
          <div className="absolute inset-0 pointer-events-none overflow-hidden">
            {fallingItems.map((item) => {
              ...
              return (
                ...
                >
                  <span className="text-[10px] md:text-sm font-black leading-tight uppercase tracking-wider">
                    {item.text}
                  </span>
                  {explanationMode && q && (
                    <div
                      className={`mt-2 text-[8px] font-medium leading-snug px-2 py-1 rounded-lg ${item.isCorrect ? "bg-teal-500/80 text-white" : "bg-red-500/80 text-white"}`}
                    >
          ...
          <div
            className={`absolute right-4 top-24 md:top-32 z-40 transition-all duration-700 stickman-rescue-sidebar-right ${isSidebarVisible ? "translate-x-0 opacity-100" : "translate-x-[120%] opacity-0"}`}
          >
            <div
              className="max-w-[200px] xs:max-w-[240px] md:max-w-[320px] bg-white/95 rounded-2xl border border-white p-4 md:p-6 shadow-4xl flex flex-col h-fit"
              style={{
            ...
            >
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-slate-900 font-black uppercase text-[9px] tracking-widest">
                  Growth Log
                </span>
              </div>
              {explanation && (
                <div
                  ...
                  key={explanation.correct}
                >
                  <div className="space-y-1">
                    <span className="text-[8px] font-black text-teal-600 uppercase tracking-widest">
                      Better choice
                    </span>
                    <p className="text-slate-800 font-bold text-xs italic leading-tight">
                      "{explanation.correct}"
                    </p>
                  </div>
                  <div className="space-y-1 opacity-50">
                    ...
                    <p className="text-slate-500 font-bold text-[9px] line-through leading-tight">
                      "{explanation.stigma}"
                    </p>
                  </div>
                  <div className="pt-3 border-t border-slate-100">
                    <p className="text-slate-600 text-[10px] md:text-xs font-medium leading-relaxed">
                      {explanation.why}
                    </p>
                  </div>
                </div>
          ...
          <div
            className={`absolute left-4 top-28 md:top-40 z-40 transition-all duration-700 stickman-rescue-sidebar-left ${isAlertVisible ? "translate-x-0 opacity-100" : "translate-x-[-120%] opacity-0"}`}
          >
            <div
              className="max-w-[200px] xs:max-w-[240px] md:max-w-[320px] bg-slate-900/95 rounded-2xl border border-red-500/30 p-4 md:p-6 shadow-[0_0_30px_rgba(239,68,68,0.2)] flex flex-col h-fit"
              style={{
                backdropFilter: "blur(20px)",
                WebkitBackdropFilter: "blur(20px)",
              }}
            >
              ...
              {stigmaAlert && (
                <div
                  className="space-y-4 animate-shake"
                  key={stigmaAlert.stigma}
                >
                  <div className="p-3 bg-red-500/10 rounded-xl border border-red-500/20">
                    <span className="text-[7px] font-black text-red-400 uppercase tracking-widest block mb-2">
                      Harmful Language
                    </span>
                    <p className="text-white font-bold text-[10px] leading-tight italic">
                      "{stigmaAlert.stigma}"
                    </p>
                  </div>
                  <div className="space-y-1">
                    ...
                    <p className="text-slate-300 text-[9px] md:text-xs font-medium leading-relaxed">
                      This terminology increases isolation. It's better to use
          ...
          <div className="absolute top-20 md:top-28 left-4 md:left-8 flex gap-1.5 md:gap-2 z-50">
            {[...Array(3)].map((_, i) => (
              <div
                key={i}
                className={`w-8 h-8 md:w-10 md:h-10 rounded-lg md:rounded-xl border-2 flex items-center justify-center shadow-lg transition-all duration-500 ${i < 3 - mistakes ? "bg-teal-500 text-white border-teal-400 shadow-teal-500/20 scale-100" : "bg-slate-900/40 text-slate-700 border-slate-800 scale-90 opacity-20"}`}
              >
                <svg
              ...
              <div className="bg-white/95 backdrop-blur-xl rounded-3xl border-2 border-white shadow-2xl p-6 max-h-[70vh] overflow-hidden flex flex-col">
                <div className="flex items-center justify-between mb-4 pb-4 border-b border-slate-200">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="text-lg font-black uppercase text-slate-800 tracking-wide">
                        Word Glossary
                      </h3>
                  ...
                  {wordHistory.map((word) => (
                    ...
                    >
                      <div className="flex items-start gap-3 mb-3">
                        <div
                          className={`w-8 h-8 rounded-lg flex items-center justify-center shrink-0 ${word.wasCorrect ? "bg-teal-100 text-teal-600" : "bg-red-100 text-red-600"}`}
                        >
                          {word.wasCorrect ? (
                            <svg
                              className="w-5 h-5"
                        ...
                        <div className="flex-1">
                          <span className="text-[8px] font-black text-teal-600 uppercase tracking-widest block mb-1">
                            Better Choice
                          </span>
                          <p className="text-sm font-bold text-slate-800 leading-tight mb-2">
                            "{word.correct}"
                          </p>
                          <span className="text-[8px] font-black text-red-600 uppercase tracking-widest block mb-1">
                            Avoid
                          </span>
                          <p className="text-xs font-medium text-slate-500 line-through leading-tight mb-3">
                            "{word.stigma}"
                          </p>
                ...
                <div className="mt-4 pt-4 border-t border-slate-200 text-center">
                  <p className="text-[10px] text-slate-400 font-bold italic">
                    {wordHistory.length} word pair
                    {wordHistory.length !== 1 ? "s" : ""} encountered
                  </p>
                </div>
              </div>
            </div>
          ...
          >
            <div className="relative">
              <div
                className={`absolute inset-0 bg-teal-400/20 blur-3xl rounded-full transition-all duration-500 ${harmony > 60 ? "scale-150" : "scale-75"}`}
              />
              <img
                src={
                  harmony > 30
          ...
          {isMobile && (
            <>
              <button
                ...
                className={`absolute bottom-40 right-6 w-14 h-14 rounded-full flex items-center justify-center transition-all border-2 z-[300] active:scale-90 shadow-2xl ${isSpeedBoosted ? "bg-orange-500 border-orange-400 shadow-[0_0_20px_rgba(249,115,22,0.5)]" : "bg-white/5 backdrop-blur-xl border-white/20 text-white/40"}`}
              >
                <span
                  className={`text-lg font-black italic tracking-tighter ${isSpeedBoosted ? "text-white scale-110" : "text-white/40"}`}
                >
                  2X
                </span>
              </button>
              ...
              <div className="absolute bottom-4 left-0 right-0 px-8 py-6 z-[200] flex flex-col items-center">
                ...
                >
                  ...
                  >
                    ...
                    <span className="text-[6px] font-black text-white/40 uppercase tracking-[0.2em] mt-1.5">
                      Slide
                    </span>
                  </div>
                </div>
      ...
      {gameState === "GAME_OVER" && (
        <div className="relative z-10 max-w-xl w-full p-6 md:p-8 text-center animate-pop-in flex flex-col items-center stickman-rescue-results">
          ...
          <h2 className="text-3xl md:text-6xl font-black text-white mb-3 md:mb-4 uppercase tracking-tighter">
            Don't Give Up!
          </h2>
          <p className="text-teal-200 text-base md:text-xl font-bold mb-4 md:mb-6 uppercase tracking-widest text-balance">
            Mistakes are part of learning. Try again!
          </p>
          <div className="flex gap-4 md:gap-6 mb-6 md:mb-8">
            <div className="flex flex-col items-center">
              <p className="text-white/50 text-[10px] md:text-xs font-black uppercase tracking-widest">
                Progress
              </p>
          ...
          <div className="flex flex-col gap-3 md:gap-4 w-full">
            <button
              onClick={startGame}
              className="w-full py-4 md:py-5 bg-white text-slate-900 rounded-xl md:rounded-2xl font-black uppercase tracking-widest text-base md:text-lg shadow-xl hover:bg-slate-100 transition-all"
            >
              Try Again
            </button>
            <button
              onClick={onExit}
              className="w-full py-3.5 md:py-5 bg-white/10 text-white border border-white/20 rounded-xl md:rounded-2xl font-black uppercase tracking-widest text-[9px] md:text-xs transition-all opacity-50"
            >
              Return
            </button>
          </div>
      ...
      {gameState === "RESULTS" && (
        <div className="relative z-10 max-w-xl w-full p-6 md:p-8 text-center animate-pop-in flex flex-col items-center stickman-rescue-results">
          ...
          <div className="flex gap-4 md:gap-6 mb-4">
            <div className="flex flex-col items-center">
              <p className="text-teal-200 text-xs md:text-sm font-bold uppercase tracking-widest">
                Final Score
              </p>
            ...
            {maxStreak > 0 && (
              <div className="flex flex-col items-center">
                ...
                <p className="text-orange-400 text-2xl md:text-3xl font-black">
                  🔥 {maxStreak}
                </p>
              </div>
            )}
          ...
          <div className="bg-white/10 backdrop-blur-xl rounded-xl md:rounded-2xl p-6 md:p-8 mb-8 md:mb-12 border border-white/20">
            <p className="text-white text-sm md:text-lg font-medium leading-relaxed italic">
              "You have successfully navigated the language of stigma. Choosing
              the right words is the first step in saving a life."
            </p>
          </div>
          <button
            onClick={onExit}
            className="w-full py-4 md:py-5 bg-teal-500 text-white rounded-xl md:rounded-2xl font-black uppercase tracking-widest text-base md:text-lg shadow-2xl hover:bg-teal-400 transition-all animate-pop-in"
          >
            Complete Module
          </button>
        </div>
